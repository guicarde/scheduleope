...
if(isset($_SESSION['cliente_nombre']))         { $nom = $_SESSION['cliente_nombre'];} else{ $nom =""; }
if(isset($_SESSION['clientefin_idclientefin']))         { $idclifin = $_SESSION['clientefin_idclientefin'];} else{ $idclifin =""; }
?>
<!DOCTYPE html>
<html lang="en">
  <head>
              ...
              <p class="centered"><a href="profile.html"><img src="../Controles/Registro/Fotos/<?php echo $_SESSION['foto']; ?>" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="GuardarCliente.php">Registrar Cliente</a></li>
                      </ul>
                  </li>
                  <?php } ?> 
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> REGISTRAR CLIENTE</h3> 
                                        ...
                                        <select class="form-control" name="c_cliente" id="id_cliente_fin" required>
                                            ...
                                            <option>--SELECCIONE--</option>
                                                                        <?php foreach ($clientesfin as $c) {   
                                                                          ...
                                                                          <option value="<?php echo $c['clientefin_idclientefin']; ?>" <?php if ($idclifin == $c['clientefin_idclientefin']) echo 'selected'; ?>><?php echo $c['clientefin_nombre']; ?></option>
                                                                      <?php } ?>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href="GuardarCliente.php" class="go-top">
