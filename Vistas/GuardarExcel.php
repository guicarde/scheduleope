              ...
              <p class="centered"><a href="profile.html"><img src="../Controles/Registro/Fotos/<?php echo $_SESSION['foto']; ?>" class="img-circle" width="60"></a></p>
                 ...
                 <?php if ($p['menu_idmenu']==9) {?>
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="GuardarExcel.php">Guardar EXCEL</a></li>
                      </ul>
                  </li>
                  <?php } ?>  
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> SUBIR EXCEL</h3> 
                
                <form class="form-horizontal style-form" action="../Controles/Registro/CExcel.php" method="POST" enctype="multipart/form-data">
                 <input type="hidden" id="hiddenperiodo" name="hidden_excel" value="save">  
                 <input type="hidden" name="idexcel" value=""/>
                     
                     <!-- Datos del Usuario -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> DATOS DEL EXCEL</h4>
                     
                          
                           <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">ARCHIVO EXCEL</label>
                                        <div class="col-sm-10">
