...
if(isset($_SESSION['procedimiento_idprocedimiento']))         { $idproc = $_SESSION['procedimiento_idprocedimiento'];} else{ $idusu =""; }
if(isset($_SESSION['procedimiento_nombre']))         { $nom = $_SESSION['procedimiento_nombre'];} else{ $nom =""; }
if(isset($_SESSION['procedimiento_archivo']))         { $link = $_SESSION['procedimiento_archivo'];} else{ $link =""; }
              ...
              <p class="centered"><a href="profile.html"><img src="../Controles/Registro/Fotos/<?php echo $_SESSION['foto']; ?>" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active" ><a  href="GuardarProcedimiento.php">Registrar Procedimiento</a></li>
                      </ul>
                  </li>
                  <?php } ?>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> REGISTRAR PROCEDIMIENTO</h3> 
                
                <form class="form-horizontal style-form" action="../Controles/Registro/CProcedimiento.php" method="POST" enctype="multipart/form-data">
                 <input type="hidden" id="hiddenprocedimiento" name="hidden_procedimiento" value="save">  
                 <input type="hidden" name="idprocedimiento" value="<?php echo $idproc ?>"/>
                     
                     <!-- Datos del Usuario -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> DATOS DEL PROCEDIMIENTO</h4>
