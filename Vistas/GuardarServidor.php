...
if(!isset($_SESSION['accion_servidor'])){ 
    $_SESSION['accion_servidor']="";
}

$privilegios = $_SESSION['array_menus'];

if(isset($_SESSION['servidor_idservidor']))         { $idserv = $_SESSION['servidor_idservidor'];} else{ $idserv =""; }
if(isset($_SESSION['servidor_hostname']))         { $hostname = $_SESSION['servidor_hostname'];} else{ $hostname =""; }
if(isset($_SESSION['servidor_ip']))         { $ip = $_SESSION['servidor_ip'];} else{ $ip =""; }
?>
<!DOCTYPE html>
<html lang="en">
  <head>
              ...
              <p class="centered"><a href="profile.html"><img src="../Controles/Registro/Fotos/<?php echo $_SESSION['foto']; ?>" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="GuardarServidor.php">Registrar Servidor</a></li>
                      </ul>
                  </li>
                  <?php } ?> 
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> REGISTRAR SERVIDOR</h3> 
                
                <form class="form-horizontal style-form" action="../Controles/Registro/CServidor.php" method="POST">
                 <input type="hidden" id="hiddenservidor" name="hidden_servidor" value="save">  
                 <input type="hidden" name="idservidor" value="<?php echo $idserv ?>"/>
                     
                     <!-- Datos del Usuario -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> DATOS DEL SERVIDOR</h4>
                     
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">HOSTNAME DEL SERVIDOR</label>
                              <div class="col-sm-10">
                                  <input type="text" name="t_hostname" class="form-control" value="<?php echo $hostname?>" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" name="t_ip" class="form-control" value="<?php echo $ip?>" required>
                              </div>
                          </div>
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        Se ha registrado satisfactoriamente el Sevidor.
						      </div>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href="GuardarServidor.php" class="go-top">
