          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <p class="centered"><a href="profile.html"><img src="../Controles/Registro/Fotos/<?php echo $_SESSION['foto']; ?>" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="MantenerClienteFinal.php">Consultar Clientes Finales</a></li>
                          <li><a  href="GuardarClienteFinal.php">Registrar Cliente Final</a></li>
                          <li class="active"><a  href="MantenerCliente.php">Consultar Clientes</a></li>
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i> ADMINISTRAR CLIENTES</h3>

                    <form class="form-horizontal style-form" action="../Controles/Registro/CCliente.php" method="POST">
                        <input type="hidden" name="hidden_cliente" value="buscar" id="hiddencliente">    
                        ...
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="form-panel">
                                    ...
                                    <label class="col-sm-2 col-sm-2 control-label">CLIENTE FINAL</label>
                                      <div class="col-sm-10">
                                              <select class="form-control" name="c_cliente" id="id_cliente_fin" required>

                                                  <option value="0">--SELECCIONE--</option>
                                                                              <?php foreach ($clientesfin as $c) {   
                                                                                ?>

                                                                                <option value="<?php echo $c['clientefin_idclientefin']; ?>"><?php echo $c['clientefin_nombre']; ?></option>
                                                                            <?php } ?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">NOMBRE DE CLIENTE</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">ESTADO DE CLIENTE</label>
                                        <div class="col-sm-10">
                        ...
                        <div class="col-md-12">
                            <div class="content-panel">
                                <table class="table table-striped table-advance table-hover">
                                    <h4><i class="fa fa-angle-right"></i> RESULTADO DE BUSQUEDA DE CLIENTES</h4>
                                    <hr>
...
<?php if ($clientes != null) { ?>
                                        <thead>
                                            <tr>
                                                ...
                                                <th><i class="fa fa-male"></i> CLIENTE FINAL </th>  
    ...
    foreach ($clientes as $r) {
        ?>
                                        ...
                                        $num++; ?></td>
                                                    ...
                                                    <td> 
                                                        <?php if ($r['cliente_estado'] == '1') { ?>
                                                            <span class="label label-info label-mini">ACTIVO</span>
                                                        <?php } ?>
                                                        <?php if ($r['cliente_estado'] == '0') { ?>
                                                            <span class="label label-danger label-mini">INACTIVO</span>
                                                        <?php } ?>
                                                    </td>

                                                    <td><?php echo $r['cliente_fecharegistro'] ?></td>
                                                    <td>
                                                        <?php
                                                        if ($r['cliente_estado'] == '1') {
                                                            ?>
                                                            <form method='POST' id="formusu" action="../Controles/Registro/CCliente.php">
                                                                <input type="hidden" name="id_hidden_eliminar" value="<?php echo $r['cliente_idcliente'] ?>">
                                                    ...
                                                    <td>
                                                        <form method='POST' id="formusu" action="../Controles/Registro/CCliente.php">
                                                            ...
                                                            <input type="hidden" name="idcliente" value="<?php echo $r['cliente_idcliente'] ?>">
...
<!--                                        <center><label>Su búsqueda no produjo ningún resultado. </label></center>-->
            ...
            <footer class="site-footer">
                <div class="text-center">
                    ...
                    <a href="MantenerCliente.php" class="go-top">
