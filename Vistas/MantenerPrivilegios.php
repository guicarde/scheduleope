...
if (isset($_SESSION['accion_privilegio']) && $_SESSION['accion_privilegio'] != '') {
    ...
    if ($_SESSION['accion_privilegio'] == 'busqueda') {
...
<html lang="en">
    <head>
        ...
        <title>SISTEMA DE CONTROL DE PLANILLA DE PAGOS</title>
                ...
                <div id="sidebar"  class="nav-collapse ">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="MantenerPrivilegios.php">Administrar Privilegios</a></li>
                      </ul>
                  </li>
                  <?php } ?>
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i> ADMINISTRAR PRIVILEGIOS DE USUARIO</h3>

                    <form class="form-horizontal style-form" action="../Controles/Registro/CPrivilegio.php" method="POST">
                        <input type="hidden" name="hidden_privilegio" value="buscar" id="hiddenprivilegio">    
                        ...
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="form-panel">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Menú</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" name="c_menu">                                      
                                                <option value="0">--SELECCIONE--</option>

<?php foreach ($menus as $m) { ?>                                                                    
                                                    <option value="<?php echo $m['menu_idmenu']; ?>"><?php echo $m['menu_nombre']; ?></option>
                                                <?php } ?>
...
<?php if ($usuarios != null) { ?>
                                        <thead>
                                            <tr>
                                                ...
                                                <th><i class=" fa fa-check-square"></i> Privilegios</th>
        ...
        ?>
                                        ...
                                        $num++; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        $privilegios = $privilegio->listar($r['usu_idusu']);
                                                         ?>
                                                        <?php if ($privilegios != null) { ?>
                                                        <?php foreach ($privilegios as $p) {   
                                                                    ?>
                                                        <label class="checkbox-inline">
                                                        <input type="checkbox" id="inlineCheckbox<?php echo $p['usumenu_idusumenu']; ?>" name="check_list[]" checked disabled value="<?php echo $p['usumenu_idusumenu']; ?>"> <?php echo $p['menu_nombre'];  ?>
                                                        </label><br>
                                                        
                                                        
                                                         <?php } ?>
                                                        <?php } else {?>
                                                        <div class="alert alert-danger"><i class="fa fa-warning"></i><b> Advertencia!</b><br>Aún No se han asignado<br>privilegios para <br>este usuario..!</div> 
                                                        <?php } ?>
                                                    </td>
                                                    <td> 
                                                    ...
                                                    <td>
                                                        <form method='POST' id="formusu" action="../Controles/Registro/CPrivilegio.php">
                                                            <input type="hidden" name="hidden_privilegio" value="buscarid">
                                                    ...
                                                    <td>
                                                        <form method='POST' id="formusu" action="../Controles/Registro/CPrivilegio.php">
                                                            ...
                                                            <input type="hidden" name="hidden_privilegio" value="eliminar">
