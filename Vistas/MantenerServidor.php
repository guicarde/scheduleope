...
if (isset($_SESSION['accion_servidor']) && $_SESSION['accion_servidor'] != '') {

    if ($_SESSION['accion_servidor'] == 'busqueda') {
        $servidores = $_SESSION['arreglo_buscado_servidor'];
    } else {
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <p class="centered"><a href="profile.html"><img src="../Controles/Registro/Fotos/<?php echo $_SESSION['foto']; ?>" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="MantenerServidor.php">Consultar Servidores</a></li>
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i> ADMINISTRAR SERVIDORES</h3>

                    <form class="form-horizontal style-form" action="../Controles/Registro/CServidor.php" method="POST">
                        <input type="hidden" name="hidden_servidor" value="buscar" id="hiddenservidor">    
...
<?php if ($servidores != null) { ?>
                                        <thead>
                                            <tr>
                                                ...
                                                <th><i class="fa fa-male"></i> HOSTNAME DE SERVIDOR</th>    
                                                 <th><i class="fa fa-fax"></i> IP DE SERVIDOR</th> 
    ...
    <?php
    $num = 1;
    foreach ($servidores as $r) {
        ?>
                                                <tr>
                                                    <td><?php echo $num;
                                        $num++; ?></td>
                                                    <td><?php echo $r['servidor_hostname'] ?></td>                                                   
                                                    <td><?php echo $r['servidor_ip'] ?></td>  
                                                    <td> 
                                                        <?php if ($r['servidor_estado'] == '1') { ?>
                                                            <span class="label label-info label-mini">ACTIVO</span>
                                                        <?php } ?>
                                                        <?php if ($r['servidor_estado'] == '0') { ?>
                                                            <span class="label label-danger label-mini">INACTIVO</span>
                                                        <?php } ?>
                                                    </td>

                                                    <td><?php echo $r['servidor_fecharegistro'] ?></td>
                                                    <td>
                                                        <?php
                                                        if ($r['servidor_estado'] == '1') {
                                                            ?>
                                                            <form method='POST' id="formusu" action="../Controles/Registro/CServidor.php">
                                                                <input type="hidden" name="id_hidden_eliminar" value="<?php echo $r['servidor_idservidor'] ?>">
                                                                <input type="hidden" name="hidden_servidor" value="anular">
                                                    ...
                                                    <td>
                                                        <form method='POST' id="formusu" action="../Controles/Registro/CServidor.php">
                                                            <input type="hidden" name="hidden_servidor" value="buscarid">
                                                            <input type="hidden" name="idservidor" value="<?php echo $r['servidor_idservidor'] ?>">
...
<!--                                        <center><label>Su búsqueda no produjo ningún resultado. </label></center>-->
            ...
            <footer class="site-footer">
                <div class="text-center">
                    ...
                    <a href="MantenerServidor.php" class="go-top">
