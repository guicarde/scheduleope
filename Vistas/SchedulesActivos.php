...
if (isset($_SESSION['accion_schedule']) && $_SESSION['accion_schedule'] != '') {
    ...
    if ($_SESSION['accion_schedule'] == 'busqueda') {
        ...
        $schedules = $schedule->listar_sc_activos();
    }
} else {
    $schedules = $schedule->listar_sc_activos();
}
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i> SCHEDULES ACTIVOS </h3>
                                        ...
                                        $num++; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form method='POST' action="../Controles/Registro/CSchedule.php">
                                                            <input type="hidden" name="id_schedule" value="<?php echo $r['schedule_idschedule'] ?>">
                                                            <input type="hidden" name="hidden_schedule" value="ver_schedule_activo">
                                                            <button type="submit" class="btn btn-theme02 btn-xs"  title="Ver Schedule Activo"><i class="fa fa-camera-retro"> VER SCHEDULE ACTIVO</i></button>
                                                        </form>   
                                                        <?php } ?>
                                                    </td>
                                                </tr>
