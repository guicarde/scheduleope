...
if (isset($_SESSION['accion_schedule']) && $_SESSION['accion_schedule'] != '') {
    ...
    if ($_SESSION['accion_schedule'] == 'busqueda') {
        ...
        $schedules = $schedule->listar_sc_finalizados();
    }
} else {
    $schedules = $schedule->listar_sc_finalizados();
}
                 ...
                 <?php if ($p['menu_idmenu']==8) {?>
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="SchedulesFinalizados.php">Schedules Finalizados</a></li>
                      </ul>
                  </li>
                  <?php } ?>  
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa fa-angle-right"></i> SCHEDULES FINALIZADOS </h3>
                        ...
                        <div class="col-md-12">
                            <div class="content-panel">
                                <table class="table table-striped table-advance table-hover">
                                    <h4><i class="fa fa-angle-right"></i> RESULTADO DE BUSQUEDA DE SCHEDULES FINALIZADOS</h4>
                                    <hr>
    ...
    foreach ($schedules as $r) {
        ?>
                                        ...
                                        $num++; ?></td>
                                                    ...
                                                    <td>
                                                        <?php if($r['schedule_estado']== '3' ){ ?>
                                                        <form method='POST' action="../Controles/Registro/CReportesPdf.php" target="_new2">
                                                            <input type="hidden" name="id_schedule" value="<?php echo $r['schedule_idschedule'] ?>">
