              ...
              <p class="centered"><a href="profile.html"><img src="../Controles/Registro/Fotos/<?php echo $_SESSION['foto']; ?>" class="img-circle" width="60"></a></p>
                 ...
                 <?php if ($p['menu_idmenu']==8) {?>
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="DetalleTareasAsignadas.php">Tareas Asignadas</a></li>
...
<?php if ($tareas_pen != null) { ?>
    ...
    foreach ($tareas_pen as $p) {
        ?>
                                                <tr style="font-size: 9px;"  <?php if($p['actividad_tws']=='1')echo 'bgcolor="68FF7E"';?>>
                                                    <td><?php echo $num;
                                        $num++; ?></td>
                                                    <td><?php echo $p['schedule_fecha'] ?></td>                                                   
                                                    <td><?php echo $p['sede_nombre'] ?></td>  
                                                    <td><?php echo $p['turno_nombre'] ?></td>  
                                                    <td><?php echo $p['turno_horainicio'] ?></td>  
                                                    <td><?php echo $p['turno_horafin'] ?></td>  
